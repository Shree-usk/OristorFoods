...
## Acceptance Criteria
- [x] Clicking the Search icon in the header (from STORY-004) opens a search overlay/modal (`src/components/storefront/search/search-overlay.tsx`) with a focused text input, on both desktop and mobile.
